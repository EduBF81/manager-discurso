 ...
 * @description Centraliza a lista oficial de temas de discursos públicos.
 * Esta lista é exportada como um array de objetos para ser usada em qualquer página do sistema.
 */
...
// Exporta o array formatado (O Parser executa apenas uma vez aqui)
export const temasFormatados = textoBrutoS99
    .split('\n')
